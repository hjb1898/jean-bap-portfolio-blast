...
function CreativeDebrief() {
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      {/* Back to home */}
        <div className="sticky top-0 z-20 -mx-5 mb-10 bg-background/85 px-5 py-3 backdrop-blur-sm sm:-mx-8 sm:mb-12 sm:px-8">
          <Link
            to="/"
            className="group inline-flex items-center gap-3 font-display text-xs tracking-widest text-muted-foreground transition-colors hover:text-foreground sm:text-sm"
          >
